...
public @interface AutomationInsert {
     ...
     */
    Class<? extends InsertInParamHandler> inParamHandler() default EntityInParamHandler.class;

    /**
     * 验证处理器
     */
    Class<? extends InsertVerifyHandler> verifyHandler() default SelfServiceImpl.class;

    /**
     * 结果处理器
     */
    Class<? extends InsertResultHandler<?>> resultHandler() default DefaultResultHandler.class;
